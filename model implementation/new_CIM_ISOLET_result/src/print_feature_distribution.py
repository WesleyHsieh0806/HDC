...
def main():
    ...
    ''' Use PCA to project the features of data'''
    ...
    for feature in range(0, 3):
        ...
        plt.legend()
        if not os.path.isdir('./new_CIM_ISOLET_result/feature_after_PCA'):
            os.makedirs('./new_CIM_ISOLET_result/feature_after_PCA')
        plt.savefig(
            './new_CIM_ISOLET_result/feature_after_PCA/{}.png'.format(str(feature)))
        plt.close()
